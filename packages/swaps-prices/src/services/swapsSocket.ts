import { WebsocketClient, KnownToken, networkTokens, NETWORK, createBinanceWsFeeds, createBitfinexWsFeeds, createCryptoComWsFeeds, createCoinbaseWsFeeds } from '@mycelium-ethereum/swaps-js';
