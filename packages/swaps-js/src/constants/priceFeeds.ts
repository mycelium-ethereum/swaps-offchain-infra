...
export const bitfinexSymbolToKnownToken: Partial<Record<string, KnownToken>> = Object.keys(
...
export const cryptoComSymbolToKnownToken: Partial<Record<string, KnownToken>> = Object.keys(
    knownTokenToCryptoComSymbols
).reduce(
    (o, k) => ({
        ...o,
