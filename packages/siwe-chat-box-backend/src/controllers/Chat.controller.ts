...
export const getListMsgByNetworkId = async (req: express.Request, res: express.Response) => {
...
export const sendMessageToAllClientsWithNetworkId = async function (req: express.Request, res: express.Response) {
    if (!req.body.content || !req.body.networkId) {
        throw new MissingFieldsError("Expected content and networkId in request body");
    }
